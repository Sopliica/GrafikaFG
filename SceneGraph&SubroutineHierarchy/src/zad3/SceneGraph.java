...
public class SceneGraph extends JPanel {
	...
	private TransformedObject triangle1,triangle2,triangle3,rect1,rect2,rect3,myFigure1,myFigure2,myFigure3,myFigure4,myFigure5,myFigure6;
	...
	private void createWorld() {
		...
		myFigure1 = new TransformedObject(myFigure);
		myFigure2 = new TransformedObject(myFigure);

		triangle2 = new TransformedObject(filledTriangle);
		rect2 = new TransformedObject(filledRect);
		myFigure3 = new TransformedObject(myFigure);
		myFigure4 = new TransformedObject(myFigure);

		triangle3 = new TransformedObject(filledTriangle);
		rect3 = new TransformedObject(filledRect);
		myFigure5 = new TransformedObject(myFigure);
		myFigure6 = new TransformedObject(myFigure);

		myFigure1
				.setTranslation(-3,2.25)
		...
		myFigure2
				...
				.setScale(0.003,0.003)
				.setColor(Color.BLACK);
		rect1.setTranslation(-2.0,2)
				.setScale(2,0.2)
				.setRotation(-15)
				.setColor(Color.RED);

		triangle1.setTranslation(-2.0,0.5)
		.setScale(0.7,1.5)
		...
		myFigure3
				.setTranslation(2.85,1.8)
				.setScale(0.002,0.002)
				.setColor(Color.BLACK);
		myFigure4
				.setTranslation(1.2,2.2)
				.setScale(0.002,0.002)
				.setColor(Color.BLACK);
		rect2.setTranslation(2.0,2)
				.setScale(1.8,0.15)
				.setRotation(-15)
				.setColor(Color.RED);

		triangle2.setTranslation(2.0,0.85)
				.setScale(0.4,1.1)
		...
		myFigure6
				...
				.setScale(0.004,0.004)
				.setColor(Color.BLACK);
		rect3.setTranslation(0,-0.7)
				.setScale(2.2,0.3)
				.setRotation(-15)
				.setColor(Color.RED);

		triangle3.setTranslation(0.0,-2.5)
				.setScale(0.8,1.8)
				.setColor(Color.BLUE);
		world.add(rect3);
		world.add(triangle3);
	...
	public void updateFrame() {
		...
		myFigure1.setRotation(frameNumber*100000000);
		myFigure2.setRotation(-frameNumber*0.75);
		myFigure3.setRotation(frameNumber*0.75);
		myFigure4.setRotation(frameNumber*0.75);
		myFigure5.setRotation(frameNumber*0.75);
		myFigure6.setRotation(frameNumber*0.75);
	}
	...
	private static SceneGraphNode myFigure = new SceneGraphNode() {
		@Override
		void doDraw(Graphics2D g) {
			int n = 10;
